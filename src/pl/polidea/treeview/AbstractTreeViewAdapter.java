...
public abstract class AbstractTreeViewAdapter<T> extends BaseAdapter implements
    ...
    public int getItemViewType(final int position) {
    	Log.d("AbstractTreeViewAdapter", "getItemViewType position:" + position + " ret:" + getTreeNodeInfo(position).getLevel() + " numberOfLevels:" + numberOfLevels);
        return getTreeNodeInfo(position).getLevel();
    }

    @Override
    public int getViewTypeCount() {
    	Log.d("AbstractTreeViewAdapter", "getItemViewTypeCount:" + numberOfLevels);
    ...
    public void setnNumberOfLevels(int numberOfLevels) {
    	this.numberOfLevels = numberOfLevels;
    }
}
